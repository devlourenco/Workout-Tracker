...
public class ExercicioController {
    ...
    public ResponseEntity<ExercicioDTO> atualizarNome(@PathVariable Long id, @RequestParam String nome) {
        ExercicioDTO exercicio = service.atualizarNome(id, nome);
        return ResponseEntity.ok(exercicio);
    }

    @PatchMapping("/{id}/grupo-muscular")
    public ResponseEntity<ExercicioDTO> atualizarGrupoMuscular(@PathVariable Long id, @RequestParam GrupoMuscularEnum grupoMuscular) {
